<template>
	<div>
		<div class="blue1">
			<section class="blue2">
				<h1 class="">Autodoprava</h1>
				<h2>
					Ponúkame spoľahlivú a <br />
					efektívnu dopravu kamiónmi <br />pre poľnohospodárstvo!
				</h2>
			</section>
		...
		<div class="container3">
			<div class="right-text3">
				...
				<br />
				<p>– Navyše, vždy dbáme na bezpečnosť a kvalitu našej práce. Naši vodiči sú školení a skúsení v riešení všetkých druhov situácií a naši kamióny sú vždy v prevádzkyschopnom stave.</p>
				<br />
			</div>
		</div>
	</div>
